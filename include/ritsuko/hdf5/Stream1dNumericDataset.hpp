...
/**
 * @brief Options for `Stream1dNumericDataset`.
 */
struct Stream1dNumericDatasetOptions {
    /**
...
public:
     ...
     */
    Stream1dNumericDataset(DataSetPointer_ data_ptr, hsize_t length, const Stream1dNumericDatasetOptions& options) : 
